...
import { Brain, Mail, Lock, ArrowRight, Loader, ArrowLeft } from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', textAlign: 'center' }}>
          ...
          <div>
            <h1 style={{ fontSize: '1.8rem', margin: 0, fontFamily: 'Playfair Display, serif' }}>Welcome Back</h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '14px', marginTop: '4px' }}>Sign in to continue your learning journey</p>
          </div>
        </div>
